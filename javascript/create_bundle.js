...
(function() {
  module.exports = function(config, dbServer) {
    var Promise, configDb, createUsers, createViews, dataDb, dbName, insert_beehouse, insert_location, insert_stand, usersDb, util;
    ...
    return configDb.create().then(function() {
      ...
      var i, j, k, len, len1, ref, ref1, role, secu;
